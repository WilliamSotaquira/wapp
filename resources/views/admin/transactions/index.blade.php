                    ...
                    for (var cont = 0; cont < data.length; cont++) {
                        ...
                        switch (data[cont].type) {
                            case "1":
                                ...
                                break;
                            case "2":
                                msg = '<span class="text-yellow-500 font-bold">Pendiente</span>';
                                break;
                            case "3":
                                msg = '<span class="text-red-500 font-bold">Sin pago</span>';
                                break;
                            default:
                                msg = 'Otro';
                                break
