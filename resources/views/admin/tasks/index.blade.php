<x-admin-layout>
    <div class="flex mb-4 justify-start">
        <x-a-button href="{{route('admin.tasks.create')}}">
            Crear Tarea
        </x-a-button>
    </div>
    ...
    <div class="overflow-x-auto shadow-md sm:rounded-lg bg-gray-900">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <caption class="p-5 text-lg font-mont font-semibold text-left text-gray-100 bg-weirdo-gray-900 dark:text-gray-100 dark:bg-gray-800">
                Tareas
                <p class="mt-1 text-sm font-normal text-gray-400 dark:text-gray-400">Una tarea es una unidad de trabajo que forma parte de un proceso. Un proceso es un conjunto de tareas relacionadas que se realizan para lograr un objetivo específico. Una tarea puede ser realizada por una persona, un equipo o una máquina, y tiene un inicio y un fin definidos. Una tarea también puede tener entradas y salidas, que son los recursos o los resultados que se consumen o se generan durante su ejecución.</p>
            </caption>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="py-2 sm:py-4 px-2 sm:px-6 text-right">
                        <div class="columns-1 sm:columns-2">
                            <div>
                                <a href="{{route('admin.tasks.edit', $task)}}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</a>
                            </div>
                            <div>
