<nav class="bg-weirdo-gray-700 dark:bg-gray-900 border-b border-weirdo-gray-900 sticky top-0 z-50">
   ...
   <div class="flex justify-between h-16">
      ...
      <div class="-mr-2 items-center hidden lg:flex">
         <button class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition"
            @click=" openSiderbar = !openSiderbar" title="menú hamberguesa">
      ...
      <div class="flex lg:hidden">
         ...
         <div class="shrink-0 flex items-center">
            <a href="{{route('admin.dashboard')}}">
               <x-jet-application-mark class="block h-9 w-auto bg-weirdo-red-900" />
            </a>
         </div>
                     ...
                     @else
                        <span class="inline-flex rounded-md">
                           <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition"
                              type="button"  title="menú hamberguesa">
                              {{ Auth::user()->name }}
         ...
         @else
            @if (Route::has('login'))
               <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                  @auth
                     <a class="text-sm text-gray-700 dark:text-gray-500 underline" href="{{ url('admin.dashboard') }}">Dashboard</a>
                  @else
      ...
      <div class="-mr-2 flex items-center lg:hidden">
         <button class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition" @click="open = ! open" title="Menú hambuerguesa">
            <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
