<aside id="sidebar-multi-level-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        ...
        <ul class="space-y-2">
            ...
            <li>
                ...
                <ul id="dropdown-finanzas" class="hidden py-2 space-y-2 fa-ul" style="--fa-li-margin: 1em;">
                    <li>
                        <a href="{{ route('admin.wallets.index')}}" class="flex items-center w-full p-2 text-base font-normal text-gray-50 transition duration-75 rounded-lg pl-8 group hover:bg-weirdo-gray-900 dark:text-white dark:hover:bg-gray-700">Bolsillos</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.budgets.index')}}" class="flex items-center w-full p-2 text-base font-normal text-gray-50 transition duration-75 rounded-lg pl-8 group hover:bg-weirdo-gray-900 dark:text-white dark:hover:bg-gray-700">Presupuestos</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.transactions.index')}}" class="flex items-center w-full p-2 text-base font-normal text-gray-50 transition duration-75 rounded-lg pl-8 group hover:bg-weirdo-gray-900 dark:text-white dark:hover:bg-gray-700">Transacciones</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.items.index')}}" class="flex items-center w-full p-2 text-base font-normal text-gray-50 transition duration-75 rounded-lg pl-8 group hover:bg-weirdo-gray-900 dark:text-white dark:hover:bg-gray-700">Articulos</a>
                    </li>
                </ul>
            </li>
            <li>
