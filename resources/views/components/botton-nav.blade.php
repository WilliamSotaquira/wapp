<div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-weirdo-gray-700 border-t border-gray-800 dark:bg-gray-700 dark:border-gray-600">
    <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
        <a href="{{ route('admin.transactions.create')}}" type="button" class="inline-flex flex-col items-center justify-center px-5 border-gray-800 border-x hover:bg-weirdo-gray-900 dark:hover:bg-gray-800 group dark:border-gray-600">
